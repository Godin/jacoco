...
class GroovyControlStructuresTarget {
    ...
    private static void missedForEachBlock() {
        ...
        for (Object o : Collections.emptyList()) { // assertPartlyCovered(2, 2)
    ...
    private static void executedForEachBlock() {
        ...
        /* TODO */
        for (Object o : Collections.singleton(new Object())) { // assertFullyCovered(1, 3)
    ...
    static void main(String[] args) {
        /* avoids failure of all_branches_should_have_line_number */
        new GroovyControlStructuresTarget()
