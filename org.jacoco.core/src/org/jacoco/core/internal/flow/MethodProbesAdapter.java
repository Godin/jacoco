...
public final class MethodProbesAdapter extends MethodVisitor {
	...
	public void visitInsn(final int opcode) {
		...
		case Opcodes.RETURN:
			// FIXME
			// valid code must have 0 monitors at RETURN,
			// but RETURN might be inside protected region,
			// so that insertion of probe will lead
			// to "monitor stack height merge conflict"
			// or "monitor stack underflow"
			// this is the case for code generated by Groovy compiler
		case Opcodes.ATHROW:
			// valid code must have
			// either unprotected ATHROW with zero monitors
			// or protected ATHROW wit non-zero monitors
			// in both cases insertion of probe is safe
	...
	public void visitJumpInsn(final int opcode, final Label label) {
		if (LabelInfo.isMultiTarget(label)) {
			// FIXME
			// JUMP might be inside of protected region
			// with no open monitors,
			// so that insertion of probe will lead
			// to "monitor stack underflow"
			//
			// or JUMP might be outside of protected region
			// with open monitors,
			// so that insertion of probe will lead
			// to "non-empty monitor stack at exceptional exit"
