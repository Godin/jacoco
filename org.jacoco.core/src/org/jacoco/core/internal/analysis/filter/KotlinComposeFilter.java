...
final class KotlinComposeFilter implements IFilter {
	...
	public void filter(final MethodNode methodNode,
		...
		for (final AbstractInsnNode i : methodNode.instructions) {
			if (i.getOpcode() == Opcodes.ILOAD
					&& ((VarInsnNode) i).var == maskVar
					&& i.getNext().getNext().getOpcode() == Opcodes.IAND
					&& i.getNext().getNext().getNext()
							.getOpcode() == Opcodes.IFEQ) {
				AbstractInsnNode ji = i.getNext().getNext().getNext();
				output.ignore(ji, ji);
			}
