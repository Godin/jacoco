...
public class RecordPatternFilterTest extends FilterTestBase {
	 ...
	 */
	@Test
	public void should_filter_exhaustive() {
		MethodNode m = new MethodNode();
		m.visitCode();
		Label label0 = new Label();
		Label label1 = new Label();
		...
		m.visitInsn(DUP);
		m.visitMethodInsn(INVOKESTATIC, "java/util/Objects", "requireNonNull",
		...
		m.visitInvokeDynamicInsn("typeSwitch", "(Ljava/lang/Object;I)I",
				new Handle(Opcodes.H_INVOKESTATIC,
						...
						false),
				new Object[] { Type.getType(
						"Lorg/jacoco/core/test/validation/java21/targets/RecordPatternsTarget$Ex;") });
		Label label4 = new Label();
		Label label5 = new Label();
		m.visitLookupSwitchInsn(label5, new int[] { 0 },
				new Label[] { label4 });
		m.visitLabel(label5);
		m.visitTypeInsn(NEW, "java/lang/MatchException");
		m.visitInsn(DUP);
		m.visitInsn(ACONST_NULL);
		m.visitInsn(ACONST_NULL);
		m.visitMethodInsn(INVOKESPECIAL, "java/lang/MatchException", "<init>",
		...
		m.visitMethodInsn(INVOKEVIRTUAL,
				"org/jacoco/core/test/validation/java21/targets/RecordPatternsTarget$Ex",
				"c",
				"()Lorg/jacoco/core/test/validation/java21/targets/Sealed;",
				false);
		m.visitLabel(label1);
		m.visitVarInsn(ASTORE, 6);
		m.visitInsn(ICONST_0);
		m.visitVarInsn(ISTORE, 7);
		...
		m.visitInvokeDynamicInsn("typeSwitch", "(Ljava/lang/Object;I)I",
				new Handle(Opcodes.H_INVOKESTATIC,
						...
						false),
				new Object[] { Type.getType(
						"Lorg/jacoco/core/test/validation/java21/targets/Sealed$A;"),
						Type.getType(
								"Lorg/jacoco/core/test/validation/java21/targets/Sealed$B;") });
		Label label6 = new Label();
		Label label7 = new Label();
		Label label8 = new Label();
		m.visitTableSwitchInsn(-1, 1, label6,
				new Label[] { label6, label7, label8 });
		m.visitLabel(label7);
		m.visitVarInsn(ALOAD, 6);
		m.visitTypeInsn(CHECKCAST,
				"org/jacoco/core/test/validation/java21/targets/Sealed$A");
		...
		m.visitVarInsn(ALOAD, 6);
		m.visitTypeInsn(CHECKCAST,
				"org/jacoco/core/test/validation/java21/targets/Sealed$B");
		...
		m.visitInsn(DUP);
		m.visitVarInsn(ALOAD, 1);
		m.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Throwable", "toString",
