...
public class TryWithResourcesTest extends ValidationTestBase {
	...
	public void test() {
		...
		if (!isJDKCompiler || JAVA_VERSION.isBefore("11")) {
			...
			assertLine("test.try", ICounter.NOT_COVERED);
		}
	...
	public void test2() {
		...
		if (!isJDKCompiler || JAVA_VERSION.isBefore("11")) {
			...
			assertLine("test2.try", ICounter.NOT_COVERED);
		}
	...
	public void returnInBody() {
		...
		if (!isJDKCompiler || JAVA_VERSION.isBefore("11")) {
			...
			assertLine("returnInBody.try", ICounter.NOT_COVERED);
		}
	...
	public void nested() {
		...
		if (!isJDKCompiler || JAVA_VERSION.isBefore("11")) {
			...
			assertLine("nested.try1", ICounter.NOT_COVERED);
		}
		...
		if (!isJDKCompiler || JAVA_VERSION.isBefore("11")) {
			...
			assertLine("nested.try2", ICounter.NOT_COVERED);
		}
		...
		if (!isJDKCompiler || JAVA_VERSION.isBefore("11")) {
			...
			assertLine("nested.try3", ICounter.NOT_COVERED, 0, 0);
		}
	...
	public void returnInCatch() {
		...
		if (!isJDKCompiler || JAVA_VERSION.isBefore("11")) {
			...
			assertLine("returnInCatch.try1", ICounter.NOT_COVERED);
		}
