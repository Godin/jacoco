...
import org.jacoco.core.internal.instr.MonitorsJvmTest;
...
public class JitTest {
	...
	public void zero_monitors_at_protected() throws Exception {
		...
		// // FIXME insertion of probe in this case turns unreachable handler
		// into
		// // reachable
		// // TODO should be possible to construct case when handler was
		// reachable
		// Monitors.compute(
	 ...
	 *
	 * @deprecated replaced by {@link MonitorsJvmTest#test1()}
	 */
	@Deprecated
	@Test
	...
	public void testKotlin() throws Exception {
		byte[] classBytes = TargetLoader
				.getClassDataAsBytes(KotlinWipTarget.class);
		classBytes = Jit.instrument(classBytes);
		String output = new JvmProcess()
				.execute(KotlinWipTarget.class.getName(), classBytes);
